...
void WriteBaseHeader(const set<Variable> &all_vars,
  ...
  for(size_t i = 0; i < names.size(); ++i){
    file << "#include \"gen_babymaker/bmaker/interface/baby_" << names.at(i) << ".hh\"\n";
  }
  file <<'\n';
...
void WriteBaseSource(const set<Variable> &all_vars,
  ...
  file << "#include \"gen_babymaker/bmaker/interface/baby_base.hh\"\n\n";
...
void WriteSepSource(const pair<string, set<Variable> > &sep_vars){
  ...
  file << "#include \"gen_babymaker/bmaker/interface/baby_base.hh\"\n\n";
  file << "#include \"gen_babymaker/bmaker/interface/baby_" << name << ".hh\"\n\n";
